...
if __name__ == "__main__":
    ...
    p_camera.add_argument("-hsf", "--halve-size-factor", type=int, default=2, help="Factor by which to halve the image size for detection (default: 2)")
    ...
    p_train.add_argument("-fpr", "--target_fpr", type=float, default=1e-8, help="Target false positive rate for training (default: 0.005)")
